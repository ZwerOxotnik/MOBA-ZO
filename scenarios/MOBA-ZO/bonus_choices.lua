return {
	...
	{{name="scatterbot-capsule", count = 1}},
	{{name="steel-plate-wall", count = 100}},
	{{name="arc-turret", count = 1}},
	{{name="photon-turret", count = 1}},
	{{name="scattergun-turret",  count = 5}},
	{{name="medical-pack", count = 4}},
	{{name="bronze-cartridge", count = 10}},
}
